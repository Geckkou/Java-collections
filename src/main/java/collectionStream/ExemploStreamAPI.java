...
public class ExemploStreamAPI {
    public static void main(String[] args) {
        ...
        //Retorna o elemento com o maior nuemro de letras
        ...
        //Retorna os elementos que tem a letras R no nome
        ...
        //Exibe cada elemnto no console, e depois retorna a mesma coleção
        System.out.println("Retorna os elmentos: " + estudantes.stream().peek(System.out::println).collect(Collectors.toList()));

        //Exibe cada elementos no console sem retornar outra coleção
        ...
        System.out.println("Tem algum elemento com a minúculo no nome? " + estudantes.stream().anyMatch((elemento) -> elemento.contains("a")));

        //Retorna true se nenhum elemento possue a letra a minúcula no nome
        System.out.println("Não tem nenhm elemento com a minúsculo no nome? " + estudantes.stream().noneMatch((elemento) -> elemento.contains("a")));
